...
# Substitua os valores NULL pelo número 0:
import pandas as pd
...
# Substitua os valores NULL nas colunas "Calorias" pelo número 0:
df.fillna({"Calories": 0}, inplace=True)    # O argumento inplace=True faz com que a modificação seja feita no DataFrame original, não sendo em um novo.
print(df.to_string())
''' Saída:
     Duration  Pulse  Maxpulse  Calories
0          60    110       130     409.1
