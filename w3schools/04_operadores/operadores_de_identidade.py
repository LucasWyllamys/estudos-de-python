...
# Retorna False porque x não é o mesmo objeto que y, mesmo que tenham o mesmo conteúdo
print(x is y)
# Para demonstrar a diferença entre "is" e "==": esta comparação retorna True porque x é igual a y
print(x == y)
